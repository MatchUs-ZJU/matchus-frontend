...
MatchUs活动特色在于以下几点：</View>
        <View className='p1 margin-bottom-12'><Text className='highlight'>1、精细匹配：</Text>按双方要求进行精细匹配，能满足参与者重视的多重要求，降低参与者的试错成本，避免出现强行配对现象。️</View>
        <View className='p1 margin-bottom-12'><Text className='highlight'>2、实名核验：</Text>活动将确保参与者均为浙江大学在校生。️</View>
        <View className='p1 margin-bottom-12'><Text className='highlight'>3、过程助攻：</Text>在规定的时点开放双向选择环节，双方各自决定是否选择继续深入了解以及是否线下见面。</View>
        <View className='p1 margin-bottom-48'><Text className='highlight'>4、真诚交友：</Text>设立举报机制防止信息造假等恶劣行为，防止海王重复交友。</View>
        ...
        <View className='p1 margin-bottom-12'><Text className='highlight'>①个人信息：</Text>包括姓名、年龄、学院、地域、身高、性格、爱好、生活习惯等，并要求上传个人照片和校园卡信息以供人工核实身份信息。</View>
        <View className='p1 margin-bottom-12'><Text className='highlight'>②匹配要求：</Text>与个人信息部分相对应，主要填写您对匹配对象的要求和期待。您需要从众多匹配指标中选择您最关注的5个指标，再填写每个指标的具体内容。</View>
